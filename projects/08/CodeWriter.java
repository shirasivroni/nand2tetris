...
public class CodeWriter {
    ...
    public void writeLabel(String label){
        writeLineToFile("//write label " + label);
        writeLineToFile("(" + label + ")");
    }

    public void writeGoto(String label){
        writeLineToFile("//write goto " + label);
        writeLineToFile("@" + label);
        writeLineToFile("0;JMP");
    }

    public void writeIf(String label){
        writeLineToFile("//write if " + label);
        writeLineToFile("@SP");
        writeLineToFile("AM=M-1");
        writeLineToFile("D=M");
        writeLineToFile("@" + label);
        writeLineToFile("D;JNE");
    }
    ...
    public void writeCall(String functionName, int nArgs){
        writeLineToFile("//write call " + functionName + " " + nArgs);
        String returnLabel = fileName + "." +  functionName + "$ret." + callIndex;
        writeLineToFile("@" + returnLabel);
        writeLineToFile("D=A");
        callPush();
    ...
    public void writeReturn(){
        writeLineToFile("//write return ");

        //gets the address at the frame's end
        writeLineToFile("@LCL");
        writeLineToFile("D=M");
        writeLineToFile("@endFrame");
        writeLineToFile("M=D");
        ...
        //repositions SP
        writeLineToFile("@ARG");
        writeLineToFile("D=M+1");
        writeLineToFile("@SP");
        writeLineToFile("M=D");

        //restores THAT
        writeLineToFile("@endFrame");
        writeLineToFile("A=M-1");
        writeLineToFile("D=M");
        writeLineToFile("@THAT");
        writeLineToFile("M=D");
